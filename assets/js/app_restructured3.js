...
function axisScale(dataArray, variable, axis) {
  ...
  function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup, textcirclesGroup) {
    ...
    textcirclesGroup.call(toolTip);
    textcirclesGroup.on("mouseover", function(data){
        toolTip.show(data, this);
    })
    .on("mouseout", function(data, index){
        toolTip.hide(data)
...
d3.csv(path).then(function(healthData, err){
  ...
  var circlesGroup = updateToolTip(chosenXAxis, chosenYAxis, circlesGroup, textcirclesGroup)
  ...
  .on("click", function() {
    ...
    if (value !== chosenXAxis) {
      ...
      circlesGroup = updateToolTip(chosenXAxis, chosenYAxis, circlesGroup, textcirclesGroup)
